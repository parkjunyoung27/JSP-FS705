...
#boardlist .bmiddle .bmfloat li {
   float: left;
}

#boardlist .bmiddle .bmfloat li:first-child {
   width: 54%;
   text-align: left;
   text-indent: 10px;
}

#boardlist .bmiddle .bmfloat li:nth-child(2) {
   width: 30%;
   text-align: right;
}

#boardlist .bmiddle .bmfloat li:nth-child(3) {
   width: 9%;
}

#boardlist .bmiddle .bmfloat li:last-child {
   width: 7%;
}

#boardlist .bmiddle .bmfloat .line {
   height: 15px;
...
#cbPlus {
   ...
   line-height: 30px;
   overflow: hidden;
   border-bottom: 1px dashed #525976;
}
...
#cbPlus p:first-child {
   width: 60%;
   text-align: left;
}

#cbPlus p:nth-child(2) {
   width: 30%;
   text-align: right;
}
...
#cwTSend2 button:hover, #cwTSend2 button:focus {
   background-color: #6FB3A3;
}
</style>
<script>
$(function(){
...
function humorVote(bno, code){
   if(code == 'blike'){
      if(confirm("해당 글을 추천하시겠습니까?")){
         location.href="./humorViewVote?vote="+ code + "&bno=" + bno;
      }
         ...
         <div id="content">
            <div id="boardlist">
               ...
               <div class="bmiddle">
                  <ul class="bmfloat">
                     <li>${dto.btitle}</li>
                     <li>${dto.name }(${dto.id}) &nbsp;| &nbsp;${dto.bdate}&nbsp;&nbsp;&nbsp;<span class="line"></span></li>
                     <li>&nbsp;조회수: ${dto.bcount }<span class="line"></span></li>
                     <li>&nbsp;댓글: ${dto.humorcommentcount }</li>
                  </ul>
               </div>
               <div class="bbottom">
                  <c:if test="${dto.bfile ne null}">
                     <img alt="${dto.bfile }" src="./humor/humorUpload/${dto.bfile }"
                        width="60%">
                  </c:if>
               ...
               <div id="likeDislike">
                  <button onclick="humorVote(${dto.bno}, 'blike');" id="likeBtn">
                     <img src="./img/like2.png" alt="좋아요">좋아요
                  </button>
                  <button onclick="humorVote(${dto.bno}, 'bdislike');"
                     id="disLikeBtn">
                     <img src="./img/dislike.png" alt="싫어요">싫어요
                  </button>
               </div>
            </div>
            ...
            <div id="comment">
               <ul>
                  <c:choose>
                     <c:when test="${dto.humorcommentcount > 0 }">
                        <li id="commentTrue">${dto.humorcommentcount }개의댓글이 있습니다.</li>
                        <li id="commentSee">▼</li>
                                       ...
                                       <div id="cbPlus">
                                          ...
                                          <p>
                                             <img src="./img/like.png" alt="좋아요"
                                                style="width: 14px; cursor: pointer;">&nbsp;${cmt.clike }
                                          </p>
                                       </div>
                                       <div class="modifyInputP">
                                          ...
                                          <div class="commentDelete">
                                             <form action="./humorCommentDelete" method="post">
                                                <input type="hidden" name="bno" value="${cmt.bno }"><input
                                                   type="hidden" name="cno" value="${cmt.cno }">
                                                <c:if test="${cmt.id eq sessionScope.id }">
                                          ...
                                          <div class="modifyWrite">
                                             <form action="./humorCommentModify" method="post">
                                                <textarea name="ccontent"
                                                   style="width: 100%; height: 100px; overflow: auto; resize: none;">${cmt.ccontent }</textarea>
                                                <input type="hidden" name="bno" value="${cmt.bno }"><input
                                                   type="hidden" name="cno" value="${cmt.cno }">
            ...
            <div class="writeBox">
               <a href="./humorWrite">글쓰기</a>
            </div>
            <div>
               <a href="./humorModify?bno=${dto.bno }">수정하기</a>
            </div>
            <div>
               <a href="./humorDelete?bno=${dto.bno }">삭제하기</a>
            </div>
         </div>
         <div id="write">
            <a href="./humorBoard">게시판으로 이동</a>
         </div>
      </div>
