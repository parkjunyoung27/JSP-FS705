			...
			<div id="boardlist">
				...
				<div class="bbottom">					
					<c:if test="${dto.bfile ne null}">
						<img alt="${dto.bfile }" src="./humor/humorUpload/${dto.bfile }" width="60%">
					</c:if>
				...
				<div id="likeDislike">
					<button onclick="humorVote(${dto.bno}, 'blike');" id="likeBtn"><img src="./img/like2.png" alt="좋아요">좋아요</button>
					<button onclick="humorVote(${dto.bno}, 'bdislike');" id="disLikeBtn"><img src="./img/dislike.png" alt="싫어요">싫어요</button>
				</div>
			</div>
				...
				<ul>
					<c:choose>
						<c:when test="${dto.humorcommentcount > 0 }">
							<li id="commentTrue">${dto.humorcommentcount }개의 댓글이 있습니다.</li>
							<li id="commentSee">▼</li>
