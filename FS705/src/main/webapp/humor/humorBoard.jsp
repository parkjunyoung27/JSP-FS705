		...
		<div id="humor" class="boardBox">		
			...
			<c:forEach items="${dto }" var="dto">
				<ul class="main" onclick="">
					<li class="title"><a href="humorView?bno=${dto.bno }">
					[<c:choose>
					 ...
					 ${dto.btitle }  [${dto.humorcommentcount }]</a></li>
			...
			<div id="divPaging">
			<c:set var="pageName" value="humorBoard" scope="request"/>
			<c:set var="PAGENUMBER" value="10" scope="request"/>
			<c:import url="/humor/humorpaging.jsp"/>														
			</div>
			<div class="writeBox">
			...
			<!-- 검색 폼 -->
				...
				<form action="./humorBoard" method="post">
