...
<div id="wrapper">
	...
	<div id="container">
		<div id="content">
			<div id="boardlist">
				<div class="btop"><a href="foodDetail?bno=${dto.bno }">[${dto.subCategory }] ${dto.btitle }</a><small id="ccount">${dto.bno }</small></div>
				<div class="bmiddle">
					<ul class="bmfloat">
				...
				<div class="bbottom">					
					<c:if test="${dto.bfile ne null}">
						<img alt="${dto.bfile }" src="./food/foodUpload/${dto.bfile }" width="60%">
					</c:if>
