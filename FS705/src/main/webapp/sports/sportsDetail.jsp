	...
	<div id="container">
		<div id="content">
			<div id="boardlist">
				...
				<div id="likeDislike">
					<button onclick="sportsVote(${dto.bno}, 'blike');" id="likeBtn"><img src="./img/like2.png" alt="좋아요">좋아요</button>
					<button onclick="sportsVote(${dto.bno}, 'bdislike');" id="disLikeBtn"><img src="./img/dislike.png" alt="싫어요">싫어요</button>
				</div>
			</div>
				...
				<ul>
					<c:choose> 
						<c:when test="${dto.commentCount > 0 }">
							<li id="commentTrue">${dto.commentCount }개의 댓글이 있습니다.</li>
							<li id="commentSee">▼</li>
		...
		<div>
		<a href="./sportsDelete?bno=${dto.bno }">삭제하기</a>	
		</div>
		</div>
	<div id="write"><a href="./sports">게시판으로 이동</a></div>
	</div>
