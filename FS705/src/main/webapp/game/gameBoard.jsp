...
.boardBox ul li:nth-child(2) {
	width: 17%;
}

.boardBox ul li:nth-child(3) {
	width: 10%;
}

.boardBox ul li:nth-child(3) img {
	height: 15px;
	float: left;
	padding-top: 12px;
	padding-right: 1px;
	...
	<div id="wrapper">
		...
		<div id="container">
			<div id="game" class="boardBox">
				<h2>
					<img alt="게임" src="./img/game.png"> 게임
				</h2>
				<!-- 구간반복지점 -->
				<c:forEach items="${dto }" var="dto">
					<ul class="main" onclick="">
						<li class="title"><a href="gameView?bno=${dto.bno }"> [<c:choose>
						...
						기타
								...
								</c:choose>] ${dto.btitle } [${dto.gamecommentcount }]
						</a></li>
