				...
				<div id="boardlist">
					...
					<div class="bbottom">
						<c:if test="${dto.bfile ne null}">
							<img alt="${dto.bfile }" src="./game/gameUpload/${dto.bfile }"
								width="60%">
						</c:if>
					...
					<div id="likeDislike">
						<button onclick="gameVote(${dto.bno}, 'blike');" id="likeBtn">
							<img src="./img/like2.png" alt="좋아요">좋아요
						</button>
						<button onclick="gameVote(${dto.bno}, 'bdislike');"
							id="disLikeBtn">
					...
					<ul>
						<c:choose>
							<c:when test="${dto.gamecommentcount > 0 }">
								<li id="commentTrue">${dto.gamecommentcount }개의댓글이 있습니다.</li>
								<li id="commentSee">▼</li>
