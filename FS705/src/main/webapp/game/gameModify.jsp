...
<div id="wrapper">
	...
	<div id="container">
		<div id="FS705Write">
			<form action="./gameModify" method="post" enctype="multipart/form-data">
				...
				<div id="writeArea">
					...
					<div id="wcontent">
						...
						<div class="filebox"> 
							...
							<input type="file" id="file" name="file" accept=".gif, .png, .jpg, .jpeg" value="./upload/gameUpload/${modifyImport.bfile }"> 
